...
insert into public.work_orders
  ...
  ('c0000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000001', 'b0000000-0000-4000-8000-000000000001', 'in_progress', now() + interval '1 hour', 'Front-end clunk, worse over bumps.', now() - interval '2 hours'),
  ('c0000000-0000-4000-8000-000000000002', 'a0000000-0000-4000-8000-000000000002', 'b0000000-0000-4000-8000-000000000003', 'open', now() + interval '1 day', 'Brakes squealing on hard stops.', now() - interval '1 day'),
...
-- Invoices: INV for the completed brake job (unpaid) and the invoiced oil service (paid).
insert into public.invoices
  (work_order_id, customer_id, subtotal, tax_rate, tax, total, status, due_date, issued_at, paid_at) values
  ('c0000000-0000-4000-8000-000000000003', 'a0000000-0000-4000-8000-000000000003', 486.50, 0.04, 19.46, 505.96, 'unpaid', (now() + interval '10 days')::date, now() - interval '1 day'),
